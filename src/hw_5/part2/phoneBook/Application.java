...
public class Application {
    public static void main(String[] args) {
        ...
        Record contact = pb.findContact("John Deer");
        if (contact != null) {
            System.out.println("Contact " + contact.getName() + " with number " + contact.getPhoneNumber() + " found");
        }
        else {
        ...
        if (found != null) {
            System.out.println("Found contact(s) with " + found.size() + " records:");
            for (Record r : found){
